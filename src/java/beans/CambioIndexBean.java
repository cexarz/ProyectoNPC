...
public class CambioIndexBean {
    ...
    public CambioIndexBean() throws Exception {
        texto = Servicios.ObtenerTextoIndex();
    }
    ...
    public void ActualizarTexto() throws Exception {
        Servicios.ActualizarTextoIndex(textoNuevo);     
    }
